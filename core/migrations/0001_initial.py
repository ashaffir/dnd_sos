# Generated by Django 3.0.7 on 2020-08-28 14:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, choices=[('IL', 'Israel'), ('USA', 'USA')], max_length=100, null=True)),
                ...
                ('id_doc', models.FileField(blank=True, null=True, upload_to=core.models.id_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'jpg', 'jpeg', 'png'])])),
                ...
                ('bank_details', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ...
                ('payment_method', models.CharField(blank=True, choices=[('Bank', 'Bank'), ('Phone', 'Phone'), ('PayPal', 'PayPal'), ('Other', 'Other')], max_length=50, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=100, null=True)),
                ('phone', models.CharField(blank=True, max_length=100, null=True)),
                ('credit_card_token', models.CharField(blank=True, max_length=100, null=True)),
