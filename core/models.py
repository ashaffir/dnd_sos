...
class Employer(models.Model):
    ...
    business_category = models.CharField(
        max_length=50, choices=BUSINESS_CATEGORY, blank=True, null=True)
    ...
    profile_pic = models.ImageField(
        null=True, blank=True, upload_to="profile_pics", default='profile_pics/no-img.jpg')
...
class Employee(models.Model):
    ...
    # Available for delivering ("open for business")
    is_available = models.BooleanField(default=False)
    # Is currently delivering or accepted delivery and going to pick up
    ...
    account_level = models.CharField(
        max_length=30, choices=ACCOUNT_LEVEL, default='Rookie')
    ...
    preferred_payment_method = models.CharField(
        max_length=100, choices=PAYMENT_METHODS, default='None')
    ...
    payment_method = models.CharField(
        max_length=50, choices=PAYMENT_METHODS, null=True, blank=True, default="None")
