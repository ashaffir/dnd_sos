...
Widget requestedOrders({Order order, User user, BuildContext context}) {
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Expanded(
                  child: Text(
                    trans.orders_status_waiting_allocaiton,
                    style: TextStyle(
            ...
            Row(
              ...
              children: [
                ...
                //         OrdersList().orderAlert(context, order, newStatus);
                //       },
                //     ),
                //   ],
                // ),
