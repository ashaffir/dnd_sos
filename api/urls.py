...
from .views import (UserRecordView, registration_view, 
                    ...
                    OrdersView, ContactView, order_update_view, order_view,order_ratings,
                    ...
                    UserLocationViewSet,BusinessOrdersViewSet,BusinessRejectedOrdersViewSet, BusinessStartedOrdersViewSet,
                    BusinessInProgressOrdersViewSet, BusinessDeliveredOrdersViewSet,BusinessRequestedOrdersViewSet, UserAvailable,
...
router.register('requested-orders', BusinessRequestedOrdersViewSet, basename='api')


router.register('started-orders', BusinessStartedOrdersViewSet, basename='api')
router.register('in-progress-orders', BusinessInProgressOrdersViewSet, basename='api')
router.register('delivered-orders', BusinessDeliveredOrdersViewSet, basename='api')
...
urlpatterns = [
    ...
    path('order-ratings/', order_ratings , name='order-ratings'),
